...
//add_filter('wp_title', 'genesis_default_title');
...
<!--[if lte IE 8]>
<link type="text/css" rel="stylesheet" href="build/css/style_ie-2.css" media="screen" />
<![endif]-->
<?php
	} else {
...
function bfg_load_assets() {
	...
	wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans:400,300,800,600|Work+Sans:200,300,400', array(), $assets_version );
	...
	$src = $use_production_assets ? '/build/js/responsive-menu.min.js' : '/build/js/responsive-menu.js';
	wp_enqueue_script( 'responsive_menu', $stylesheet_dir . $src, array( 'jquery' ), $assets_version, true );
	wp_localize_script(
		'bfg',
		'grunticon_paths',
		array(
	...
	wp_localize_script( 'responsive_menu', 'LeavenL10n', $output );
...
add_action( 'genesis_header', 'nchfo_genesis_header_markup_open', 5 );
//add_action( 'genesis_header', 'nchfo_genesis_header_markup_close', 15 );
//add_action( 'genesis_header', 'nchfo_genesis_do_header' );

function nchfo_genesis_header_markup_open(){
	$stylesheet_dir = get_stylesheet_directory_uri();
?>

<header class="site-header" itemscope itemtype="http://schema.org/WPHeader">
	<div class="wrap">	
		<div class="header-logo"><a id="logo-text" href="/"><img alt="Classic Watches" title="Classic Watches" src="<?=$stylesheet_dir?>/images/template/CW_logo_1.png"/></a></div>
	</div>
</header>
